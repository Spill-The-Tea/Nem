...
const Bitboard InFront[8] = { ~RANK1, ~(RANK1 | RANK2), RANK4 | HALF_OF_BLACK, HALF_OF_BLACK, HALF_OF_BLACK & ~RANK5, RANK7 | RANK8, RANK8, EMPTY };
const Bitboard InBack[8] = { EMPTY, RANK1, RANK1 | RANK2, HALF_OF_WHITE & ~RANK4, HALF_OF_WHITE, HALF_OF_WHITE | RANK5,  ~(RANK7 | RANK8), ~RANK8 };
...
const Bitboard CENTER = 0x1818000000;
const Bitboard EXTENDED_CENTER = 0x3c3c3c3c0000;
const Bitboard CENTER_FRAME = EXTENDED_CENTER & ~CENTER;
...
inline Bitboard FrontFillNorth(Bitboard gen) {
	gen |= (gen << 8);
	gen |= (gen << 16);
	gen |= (gen << 32);
	return gen;
...
inline Bitboard FrontFillSouth(Bitboard gen) {
	gen |= (gen >> 8);
	gen |= (gen >> 16);
	gen |= (gen >> 32);
	return gen;
